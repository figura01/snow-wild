...
const SizeLabel: React.FC<ISizeLabel> = ({
  label,
  isActive,
  onHandleClickSize,
  field,
  ...
  return (
    <button
      className={`hover:border-black border-2 rounded-lg w-14 flex px-3 py-2 text-center items-center justify-center text-sm 
